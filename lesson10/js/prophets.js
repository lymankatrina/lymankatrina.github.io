...
.then(function (jsonObject) {
    ...
    prophets.forEach(prophet => {
        ...
        pimg.setAttribute('alt', `Portrait of ${prophet.name} ${prophet.lastname} who was born in ${prophet.birthplace} in the year ${prophet.birthdate.substring(prophet.birthdate.length - 4)}!`); 
        card.append(h2);
        card.append(p1);
        card.append(p2);
        card.append(pimg); 
